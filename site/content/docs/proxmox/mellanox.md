...
The NICs I use are Mellanox cards.
Configuring these cards is a bit of a challenge, since it requires drivers and configuration on the host.

{{% hint info %}}
For CX-3 I used firmware *4.22.1-417-LTS* successfully up until linux kernel 6.17.2-1-pve (2025-10-21T11:55Z) for Proxmox
(6.14.11-4-pve (2025-10-10T08:04Z) was the last successful kernel for MFT).
I had to use MFT version (*4.34.0-145*) to get compatibility with kernel 6.17.
{{% /hint %}}
...
- [mlxfwmanager: I used this tool to upgrade firmware](https://docs.nvidia.com/networking/display/mftv4250/mlxfwmanager+–+firmware+update+and+query+tool)
